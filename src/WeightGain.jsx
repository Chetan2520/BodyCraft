...
const WeightGain = () => {
  const steps = [
    { 
      ...
      step: "Check BMI", 
      date: "Step 1",
      description: "Determine your current body mass index to set realistic goals",
    ...
    { 
      ...
      date: "Step 2",
      description: "Calculate your daily calorie needs for healthy weight gain",
    ...
    { 
      ...
      step: "Workout", 
      date: "Step 3",
      description: "Follow a structured workout plan to build muscle mass",
    ...
    { 
      ...
      step: "Rest", 
      date: "Step 4",
      description: "Allow your body to recover and muscles to grow",
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-32 left-32 floating-icon">
          <GiMuscleUp className="text-6xl text-purple-500/30" />
        </div>
        <div className="absolute bottom-32 right-32 floating-icon">
          <GiWeightLiftingUp className="text-6xl text-blue-500/30" />
        </div>

        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          <h1 className="hero-title text-6xl md:text-8xl font-bold mb-8">
            <span className="gradient-text bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 bg-clip-text text-transparent bg-[length:200%_auto]">
              Transform
            </span>
            <br />
          ...
          <p className="hero-subtitle text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            Embark on a journey to build strength, gain healthy weight, and achieve the physique you've always dreamed of
          </p>
          ...
          <button 
            ...
            className="group bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25 flex items-center gap-3 mx-auto"
          >
      ...
      {/* Steps Section */}
      <div id="weight-gain-section" className="steps-section relative py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl font-bold mb-6">
              Your <span className="gradient-text bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Roadmap</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Follow these proven steps to achieve sustainable weight gain and muscle growth
            </p>
          </div>
